  ...
  return (
    <Card className="w-full">
      <CardContent className="p-6">
        <div
          className={`dropzone flex flex-col items-center justify-center p-8 min-h-[300px] cursor-pointer ${
        ...
        >
          ...
          <h3 className="text-xl font-medium text-gray-800 mb-2">Upload Breast Cancer Image</h3>
